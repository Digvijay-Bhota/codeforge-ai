...
class EventType(str, Enum):
    ...
    GITHUB_COMMAND_DISPATCHED = "GITHUB_COMMAND_DISPATCHED"
    GITHUB_COMMAND_FAILED = "GITHUB_COMMAND_FAILED"
    GITHUB_STATUS_DISPATCHED = "GITHUB_STATUS_DISPATCHED"
    GITHUB_STATUS_FAILED = "GITHUB_STATUS_FAILED"
    GITHUB_CHECK_RUN_CREATED = "GITHUB_CHECK_RUN_CREATED"
    GITHUB_CHECK_RUN_UPDATED = "GITHUB_CHECK_RUN_UPDATED"
